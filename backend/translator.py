...
class MultiLanguageTranslator:
    ...
    def translate_text(self, text, source_lang, target_lang):
        ...
        try:
            ...
            print(f"Translation ({self.SUPPORTED_LANGUAGES.get(source_lang, source_lang)} to {self.SUPPORTED_LANGUAGES.get(target_lang, target_lang)}): {translated_text}")
    ...
    def full_translation_pipeline(self, audio_path, source_lang, target_lang, voice_option=1, output_audio_path="temp_translation.mp3"):
        """Complete translation pipeline with optional audio output file"""
        try:
            # Step 1: Convert audio to text
            source_text = self.audio_to_text(audio_path, source_lang)
            if not source_text:
                return {'error': 'Could not recognize speech from audio'}
            ...
            return {
                ...
                'audio_path': output_audio_path if output_audio_path else None
            }
